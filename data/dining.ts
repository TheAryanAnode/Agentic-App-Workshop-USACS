...
export const diningLocations: DiningLocation[] = [
  {
    ...
    hours: "7:00 AM–9:00 PM (mock weekday hours)",
  ...
  },
  {
    ...
    hours: "7:30 AM–8:00 PM (mock weekday hours)",
  ...
  },
  {
    ...
    hours: "Closed for redevelopment (mock workshop status)",
    cuisine: ["campus landmark"],
    mealPlan: false,
    description:
      "A historic College Avenue dining location included for realistic status questions.",
  },
  {
    kind: "dining",
    id: "the-atrium",
    ...
    hours: "10:00 AM–11:00 PM (mock weekday hours)",
